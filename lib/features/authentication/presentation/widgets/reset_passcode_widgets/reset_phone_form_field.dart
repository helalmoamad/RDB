...
/// الفرق الجوهري عن النسخة القديمة: أيقونة الهاتف تُمرَّر عبر `prefixIcon`
/// (ظاهرة دائماً) بدل `prefix` (التي تظهر فقط عند التركيز/وجود نص).
double _resetCursorOffset = 0;

// ignore: must_be_immutable
class ResetPhoneFormField extends StatelessWidget {
  ResetPhoneFormField({
    super.key,
    this.controller,
    this.onTap,
                ...
                child: Directionality(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      // الفرق الجوهري: prefixIcon (ظاهرة دائماً) بدل prefix.
...
class ResetPhoneNumberFormatter extends TextInputFormatter {
